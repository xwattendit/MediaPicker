...
public final class SelectionCreator {
    ...
    public SelectionCreator cropSize(UcropSize size) {
        mSelectionSpec.size = size;
        return this;
    }
    ...
    public SelectionCreator selected(List<Item> selected) {
        if (selected != null) {
            if (mSelectionSpec.selected == null)
                mSelectionSpec.selected = new HashSet<>();
            else
                mSelectionSpec.selected.clear();
            mSelectionSpec.selected.addAll(selected);
        }
        return this;
    }
     ...
     * 1. {@link com.lxj.matisse.engine.impl.GlideEngine}
     * 2. {@link com.lxj.matisse.engine.impl.PicassoEngine}
